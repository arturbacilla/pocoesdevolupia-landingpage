...
export default function Policy() {
	return (
		<main className="w-full flex flex-col gap-[1rem] p-[1rem] text-[75%]">
			...
			<p>
				A sua privacidade é importante para nós. É política do Poções de Volúpia
			...
			<p>
				...
				<a
					...
					target="_blank"
					className="background-color: transparent; color: rgb(68, 68, 68);"
				>
			...
			<p>
				...
				informação que o Poções de Volúpia oferece no site e com caráter
			...
			<ul className="list-disc list-inside px-[1rem] flex flex-col gap-2">
				...
				<li>
					...
					(softwares) do Poções de Volúpia, de seus fornecedores ou terceiros,
