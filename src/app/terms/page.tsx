...
export default function Terms() {
	return (
		<main className="w-full flex flex-col gap-[1rem] p-[1rem] text-[75%]">
			<h2 className="font-black">1. Termos</h2>
			<p className="font-light">
				Ao acessar ao site{" "}
				<Link className="underline!" href="https://pocoesdevolupia.club">
					Poções de Volúpia
				</Link>
			...
			<p className="font-light">
				...
				materiais (informações ou software) no site Poções de Volúpia , apenas
			...
			<ol className="list-decimal list-inside px-[1rem] flex flex-col gap-2">
				...
				<li>
					...
					contido no site Poções de Volúpia;&nbsp;
				</li>
				<li>
			...
			<p className="font-light">
				...
				dessas restrições e poderá ser rescindida por Poções de Volúpia a
			...
			<ol className="list-decimal list-inside px-[1rem] flex flex-col gap-2">
				<li>
					Os materiais no site da Poções de Volúpia são fornecidos 'como estão'.
					Poções de Volúpia não oferece garantias, expressas ou implícitas, e,
				...
				<li>
					Além disso, o Poções de Volúpia não garante ou faz qualquer
			...
			<p className="font-light">
				Em nenhum caso o Poções de Volúpia ou seus fornecedores serão
				...
				decorrentes do uso ou da incapacidade de usar os materiais em Poções de
				Volúpia, mesmo que Poções de Volúpia ou um representante autorizado da
				Poções de Volúpia tenha sido notificado oralmente ou por escrito da
			...
			<p className="font-light">
				Os materiais exibidos no site da Poções de Volúpia podem incluir erros
				técnicos, tipográficos ou fotográficos. Poções de Volúpia não garante
				que qualquer material em seu site seja preciso, completo ou atual.
				Poções de Volúpia pode fazer alterações nos materiais contidos em seu
				site a qualquer momento, sem aviso prévio. No entanto, Poções de Volúpia
				não se compromete a atualizar os materiais.
			</p>
			<h2 className="font-black">6. Links</h2>
			<p className="font-light">
				O Poções de Volúpia não analisou todos os sites vinculados ao seu site e
				não é responsável pelo conteúdo de nenhum site vinculado. A inclusão de
				qualquer link não implica endosso por Poções de Volúpia do site. O uso
				de qualquer site vinculado é por conta e risco do usuário.
			</p>
			<h3>Modificações</h3>
			<p className="font-light">
				O Poções de Volúpia pode revisar estes termos de serviço do site a
			...
			<p className="font-light">
				...
				leis do Poções de Volúpia e você se submete irrevogavelmente à
