...
const entregaveis: IEntregaveis[] = [
	{
		...
		description:
			"Você vai ter acesso a um grupo exclusivo no Whatsapp. Lá você vai receber todas as atividades e informações de acesso do Poções de Volúpia!",
	},
	{
		id: "conto",
		...
		description:
			"Você receberá por email um conto erótico para ter uma amostra do que está por vir quando você se juntar ao clube!",
	},
];
					...
					{entregaveis.map((item) => (
						...
						>
							...
							<div className="flex flex-col">
								...
								<span className="text-card! text-[60%]!">
									{item.description}
								</span>
							</div>
						</div>
